...
export function validateBoardConfig(raw) {
	...
	if (raw.presets !== undefined && (!raw.presets || typeof raw.presets !== 'object' || Array.isArray(raw.presets))) errors.push('presets must be an object');
	...
	if (ui && typeof ui === 'object' && !Array.isArray(ui)) {
		...
		if (ui.hiddenColumns !== undefined && (!Array.isArray(ui.hiddenColumns) || ui.hiddenColumns.some(key => typeof key !== 'string'))) errors.push('ui.hiddenColumns must be an array of strings');
